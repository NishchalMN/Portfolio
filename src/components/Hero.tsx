...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center pt-16 px-4 sm:px-6 lg:px-8 bg-center bg-no-repeat relative"
      style={{ backgroundImage: 'url(/main_bg.png)', backgroundSize: '100% auto' }}
    >
