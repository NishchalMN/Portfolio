...
const allProjects: Project[] = [
  ...
  },
  {
    ...
    description: 'Transformer-based In-Context Learning policy with cross-attention enabling zero-shot drone adaptation to new tracks using only 3 demonstrations, achieving 42% lower MSE than behavioral cloning at 60Hz real-time inference.',
  ...
  },
  {
    ...
    description: 'Designed a fault-tolerant Database-as-a-Service on AWS supporting 2000+ RPS with Raft-based leader election, automatic failover, and read/write routing via RabbitMQ RPC, achieving zero-downtime recovery under node failure.',
